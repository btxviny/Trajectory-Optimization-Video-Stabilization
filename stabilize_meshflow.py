...
def optimize_path(path,lambda_weights,frame_count):
...
if __name__ == '__main__':
    ...
    frame_count,_,_,_ = frames.shape
    grid_paths, lambda_coeff = motion_estimation(frames)
    lambda_coeff = np.full((frame_count -1), 5)
    stable_grid_path = optimize_path(grid_paths, lambda_coeff,frame_count)
    warps = stable_grid_path - grid_paths
